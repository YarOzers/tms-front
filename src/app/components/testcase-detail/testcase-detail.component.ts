import {AfterViewInit, ChangeDetectorRef, Component, NgModule, Renderer2} from '@angular/core';
...
@Component({
  ...
  styleUrl: './testcase-detail.component.css'
})
export class TestcaseDetailComponent implements AfterViewInit{
  constructor(
  ...
  public ngAfterViewInit(): void {
    ...
    console.log('ngAfterViewInit completed', this.isLayoutReady);
